    ...
    <div>
      <div className="box is-small">
        <article className="panel is-danger">
          ...
          {isobjective
            ? <RadioQuestion number={number} question={questions[number]} setAnswerToQuestion={setAnswerToQuestion} />
            : <TextQuestion showToast={showToast} number={number} question={questions[number]} setAnswerToQuestion={setAnswerToQuestion} />}
        </article>
      </div>
    </div>
  );
