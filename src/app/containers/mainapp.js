...
function Mainapp() {
  ...
  const languageChange = (e) => {
    ...
    if (part == 3) updateRecommendations(analyzer(answers, newlang));
        ...
        return (
          <div>
            <div className="printbutton">
              <center>
                <button className="button is-danger is-light printbutton" onClick={() => window.print()}>Print the report</button>
                <button className="button is-success is-light printbutton" onClick={retake}>Retake the quiz!</button>
              </center>
              <br />
  ...
  return (
    ...
    <div className="container is-widescreen">
      <LanguageSelector languages={languages} languageChange={languageChange} goHome={gohome} part={part} language={language} />
